...
const PublishedPassport = () => {
    ...
    const generate =()=>{
        QRCode.toDataURL("https://acme.dpp.spherity.com/authorized").then(setSrc)
    }
  return (
    <div className="mt-8">
        <Headline />
        ...
        <div className="text-lg font-bold mb-4 flex justify-center">Battery Passport Link : https://acme.dpp.spherity.com</div>
